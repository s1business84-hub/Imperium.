    ...
    <main className="min-h-screen">
      ...
      <BackgroundBeamsWithCollision>
        <div className="relative z-20 text-center">
          <h1 className="text-2xl md:text-4xl lg:text-7xl font-bold text-center text-black dark:text-white font-sans tracking-tight">
            Welcome to{" "}
            <div className="relative mx-auto inline-block w-max [filter:drop-shadow(0px_1px_3px_rgba(27,_37,_80,_0.14))]">
              <div className="absolute left-0 top-[1px] bg-clip-text bg-no-repeat text-transparent bg-gradient-to-r py-4 from-teal-500 via-cyan-500 to-blue-500 [text-shadow:0_0_rgba(0,0,0,0.1)]">
                <span>Imperium.</span>
              </div>
              <div className="relative bg-clip-text text-transparent bg-no-repeat bg-gradient-to-r from-teal-500 via-cyan-500 to-blue-500 py-4">
                <span>Imperium.</span>
              </div>
            </div>
          </h1>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <CardSpotlight className="h-full">
              <div className="relative z-20">
                ...
                <h3 className="mb-3 text-xl font-semibold text-white">Clinical Reasoning Support</h3>
            ...
            <CardSpotlight className="h-full">
              <div className="relative z-20">
                ...
                <h3 className="mb-3 text-xl font-semibold text-white">Educational Focus</h3>
                <p className="text-neutral-300">
            ...
            <CardSpotlight className="h-full">
              <div className="relative z-20">
                ...
                <h3 className="mb-3 text-xl font-semibold text-white">Privacy & Safety</h3>
                <p className="text-neutral-300">
            ...
            <CardSpotlight className="h-full">
              <div className="relative z-20">
                ...
                <h3 className="mb-3 text-xl font-semibold text-white">AI-Powered Insights</h3>
                <p className="text-neutral-300">
            ...
            <CardSpotlight className="h-full">
              <div className="relative z-20">
                <div className="mb-4 inline-flex rounded-lg bg-red-500/20 p-3">
            ...
            <CardSpotlight className="h-full">
              <div className="relative z-20">
                ...
                <h3 className="mb-3 text-xl font-semibold text-white">Collaborative Learning</h3>
                <p className="text-neutral-300">
